                ...
                <form className="flex-auto p-6">
                  ...
                  <div className="flex space-x-4 mb-6 text-sm font-medium">
                    <div className="flex-auto flex space-x-4">
                      <button className="h-10 px-6 font-semibold rounded-md border border-slate-200 text-slate-900 hover:text-blue-300 hover:bg-red-400 transition duration-300" type="button" onClick={() => dispatch(add_to_cart(item))}>
                        Add To cart
                      </button>
                    </div>
                    <button className="flex-none flex items-center justify-center w-9 h-9 rounded-md text-red-600 border border-black-200" type="button" aria-label="Like" onClick={() => dispatch(add_to_whishlist(item))}>
                    <FaRegHeart/>
                    </button>
                  </div>
