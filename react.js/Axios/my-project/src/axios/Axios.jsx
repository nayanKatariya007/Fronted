  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center h-lvh'>
        ...
        <button className='p-2 bg-purple-500 text-white' onClick={handleSubmit}>POST</button>
        <button className='p-2 bg-purple-500 text-white mx-4' onClick={handleUpdate}>PUT</button>
        <button className='p-2 bg-purple-500 text-white' onClick={handleDelete}>Delete</button>
        </div>
      </div>
      <Image/>
    </div>
