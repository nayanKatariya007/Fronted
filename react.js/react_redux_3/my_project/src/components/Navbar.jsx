...
export function Navbar() {
  ...
  return (
    <div className="sticky top-0 w-full z-50 bg-white">
      <div className=" flex bg-blue-500 items-center justify-between border border-black px-4 py-2 sm:px-6 lg:px-8">
            ...
            {menuItems.map((item) => (
              <li key={item.name}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-sm font-semibold text-black underline "
        ...
        <div className="hidden lg:flex space-x-4">
          ...
          <div className="relative  gap-x-5 ">
            <Link to="/whishlist">
              ...
              <button className="rounded-md  mx-5  bg-black px-3 py-2 text-xl font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                <NavLink to="/login">
                  <TbLogin2 />
                </NavLink>
              </button>
